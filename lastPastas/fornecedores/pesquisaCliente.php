					...
					<table class="tabelIniCli">
						...
						<?php
							...
							if($busca == "" OR $busca == NULL){
								...
								$dados = mysqli_query($conect, "SELECT * FROM clientes WHERE clientes.nome LIKE '%$busca%' OR situacao='$busca'  ");
							}
								...
								echo"
									<tr class='um'>
										...
										<td id='acoes' style='width: 80px;'align='center'>
											...
											<a href=\"alterarCliente.php?id=$id\"><button class='btn' id='ed' title='Editar'><i class='fa fa-pencil' aria-hidden='true'></i></button></a>
										</td>
