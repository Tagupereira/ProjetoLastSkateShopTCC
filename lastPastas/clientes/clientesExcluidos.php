...
<!--||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||-->
		...
		<div class="container">
			...
			<div class="cabecalhoAreceber"><i class="fa fa-user-times" aria-hidden="true"></i> Clientes Excluidos</div>
					...
					<div class="contasettingsareceber" id="tabelaareceber">
						<table class="tabelIniCli">
							...
							<?php
								...
								$dados = mysqli_query($conect, "SELECT * FROM clientes WHERE situacao = 'inativo' ");
								...
								while($coluna = mysqli_fetch_array($dados)){
									...
									echo"
										...
										<div class='modal' id='$id'>
											...
											<a href=\"deleteCli.php?id=$id&validate=del\"><button class='btnMod' id='exc'>Excluir</button></a>
										</div>
